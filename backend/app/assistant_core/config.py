...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "1. The user may write or speak in Uzbek, Russian, or English.\n"
    "2. You MUST ALWAYS respond in Russian, regardless of what language "
    "the user used.\n"
    "3. NEVER switch to Uzbek or English in your response, even if the "
    "user writes in those languages or explicitly asks you to answer in "
    "another language.\n"
    "4. Exception: code examples may remain in English; if the user "
    "explicitly asks for a translation of specific text, provide that "
    "translation in the requested language, but keep the rest of your "
    "response in Russian."
)
